...
module.exports = {
  ...
  run: async (client, message, args, prefix) => {
    ...
    if (!channel.isTextBased()) return message.reply({ embeds: [new EmbedBuilder().setColor(color).setDescription("<:11:1052589045374533653> That's not a text channel.")] });
    ...
    return message.reply({
      embeds: [new EmbedBuilder().setColor(color).setDescription(`<:10:1052589041717092412> <#${channel.id}> has been unlocked.`)]
    });
  }
};
